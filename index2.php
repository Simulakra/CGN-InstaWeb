...
<header id="header">
<h1 ><a  href="index.php" style="cursor: pointer;text-decoration:none" ><img class="logo" src="assets/images/favicon/apple-touch-icon-72x72.png" /><strong><span class="logocolor">BUTİK OTEL</span></strong><span class="respon">ALAÇATI</span></a>
<nav>
<ul>
											...
											<div class="content">
												<div class="table">
													<div class="table-cell">
														<article class="thumb">
															<a href="'.$post->videos->standard_resolution->url.'" class="vid" data-poptrox="youtube,800x400"><img src="'.$post->images->standard_resolution->url.'" /></a>
									...
									<div class="square">
										<div class="content">
											<div class="table">
												<div class="table-cell">
													<article class="thumb">
														<a href="'.$post->images->standard_resolution->url.'" class="image"><img src="'.$post->images->standard_resolution->url.'" alt="" /></a>
